# Plano de Exploração — int-aprendizado-maquina
...
- [x] **Arqueólogo** — Análise do módulo `exploracao_dados`
- [x] **Arqueólogo** — Análise do módulo `preparacao_dados`
- [x] **Arqueólogo** — Análise do módulo `tokenizacao`
- [x] **Arqueólogo** — Análise do módulo `carregamento_modelo_base`
- [x] **Arqueólogo** — Análise do módulo `aplicacao_lora`
- [x] **Arqueólogo** — Análise do módulo `treino`
- [x] **Arqueólogo** — Análise do módulo `avaliacao_qualitativa`
...
- [x] **Redator** — OpenAPI (se aplicável) — não aplicável, sem API no projeto
...
- [x] **Revisor** — Resolução de lacunas com o usuário (5 perguntas adiadas por decisão do Pablo)
